...
function HistorySection() {
  ...
  const { data, error } = useSWR(`info/${addr}1`, async function () {
    ...
    return { accountType, ...accountData, balance, txs: txs.reverse() };
  });
        ...
        <>
          ...
          >
            ...
            >
              ...
              {data.accountType === "app" && (
                <>
                  <li>chains: {data?.chains?.toString()}</li>
                  <li>maxRelays: {data?.maxRelays?.toString()}</li>
                  <li>stakedTokens: {data?.stakedTokens?.toString()}</li>
                  <li>status: {data?.status?.toString()}</li>
                  <li>unstakingTime: {data?.unstakingTime?.toString()}</li>
                </>
              )}
              {data.accountType === "node" && (
                <>
                  <li>chains: {data?.chains?.toString()}</li>
                  <li>jailed: {data?.jailed?.toString()}</li>
                  <li>publicKey: {data?.publicKey?.toString()}</li>
                  <li>serviceUrl: {data?.serviceUrl?.toString()}</li>
                  <li>stakedTokens: {data?.stakedTokens?.toString()}</li>
                  <li>status: {data?.status?.toString()}</li>
                  <li>unstakingTime: {data?.unstakingTime?.toString()}</li>
                </>
